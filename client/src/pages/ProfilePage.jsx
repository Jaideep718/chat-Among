      ...
      >
        ...
        >
          ...
          <input
            ...
            className="p-2 border-2 border-gray-500 rounded-md focus:ring focus:outline-none focus:ring-violet-500"
          />
          <textarea
          ...
          <button
            type="submit"
            className="text-white p-2 bg-gradient-to-r from-purple-400 to-violet-600 rounded-full cursor-pointer text-lg"
          >
            Save
          </button>
        </form>
